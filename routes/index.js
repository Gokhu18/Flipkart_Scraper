...
router.post("/home", async (req, res, next) => {
    try {
        ...
        var htmlpage = await request.get("https://www.flipkart.com/search?q=" + search + "&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=off&as=off&page=1");
        ...
        if (numberofPages < arr[3]) {
            ...
            res.send("result available till " + arr[3]);
        }
    } catch (err) {
        console.error(err);
    }
